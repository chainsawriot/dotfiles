...
mode "stumpwm" {
     ...
     bindsym Shift+q exec i3-msg exit
     bindsym b exec i3-msg "[class=firefox] focus" || exec firefox; mode "default"
     bindsym c exec i3-msg "[instance=gnome-terminal-server] focus" || exec $term; mode "default"
     bindsym e exec i3-msg "[instance=emacs] focus" || exec emacsclient -c; mode "default"
     bindsym s exec i3-msg "[instance=spotify] focus" || exec spotify; mode "default"
     ## C-. o to use only the laptop screen; C-. O to change it back
     bindsym o exec --no-startup-id xrandr --output eDP-1 --auto; exec --no-startup-id xrandr --output HDMI-1 --off ; mode "default"
     ##bindsym Shift+o exec --no-startup-id xrandr --output HDMI-1 --auto; exec --no-startup-id xrandr --output eDP-1 --off ; mode "default"
